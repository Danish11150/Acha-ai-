...
CLIENT_ID        = "aapka_google_client_id"      # Google Cloud Console se lo
CLIENT_SECRET    = "aapka_google_client_secret"   # Google Cloud Console se lo
REFRESH_TOKEN    = "aapka_refresh_token"           # OAuth Playground se lo (permanent!)
